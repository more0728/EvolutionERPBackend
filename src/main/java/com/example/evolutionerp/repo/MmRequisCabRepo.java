...
import com.example.evolutionerp.model.MmRequisCab;
import com.example.evolutionerp.model.MmRequisCabId;
...
public interface MmRequisCabRepo extends IGenericRepo<MmRequisCab,MmRequisCabId> {
  ...
  Page<MmRequisCab> filtrar(@Param("soc") String soc, @Param("estado") String estado, @Param("cencos") String cencos, @Param("prio") String prio, @Param("fecIni") java.time.LocalDateTime fecIni, @Param("fecFin") java.time.LocalDateTime fecFin, @Param("q") String q, Pageable pageable);
}
